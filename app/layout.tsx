...
export default async function Layout({
  ...
  // BODY CLASS
  const bodyClassName = `flex flex-col min-w-[350px] items-center select-none ${redHatDisplay.variable} antialiased bg-[#0f0f0f] text-[#f1f1f1]`;
    
  return (
    <html lang="es" className="dark bg-[#0f0f0f]">
      {isProduction && (
        <head>
