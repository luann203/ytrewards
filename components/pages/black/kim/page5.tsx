...
export default function Page({
  ...
  return (
    <>
      <div className="flex flex-col text-center text-sm rounded-3xl gap-5 bg-gradient-to-t appear border px-4 py-6 from-[#181818] to-[#212121] border-[#303030]">
        <span className="text-base sm:text-2xl font-bold text-balance tracking-tight text-[#f1f1f1]">
