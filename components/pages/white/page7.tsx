...
export default function Page7() {
  ...
  return (
    <>
      <div className="flex flex-col text-center text-base rounded-2xl gap-5 bg-gradient-to-t appear px-2 pt-7 pb-2 from-[#181818] to-[#212121] border border-[#303030]">
        <span className="text-base sm:text-xl font-semibold tracking-tight text-[#f1f1f1]">
          🚨 ¡ATTENTION! Watch the video until the end to understand how to withdraw your available balance. ⬇️
        </span>
        {visible && (
          <div className="flex flex-none max-w-max justify-center items-center text-sm font-bold rounded-lg border-2 animate-pulse gap-1.5 mx-auto px-2.5 py-2 z-50 text-[#f44336] border-[#d32f2f] bg-[#1e1e1e]">
      ...
      <div className="text-sm text-center p-2 text-[#aaaaaa]">
        🔊 Check if your sound is activated
      </div>

      <div className="bg-[#181818] rounded-xl border border-[#303030]">
        <div className="flex items-center justify-between text-[#aaaaaa] text-sm border-b border-[#303030] p-4">
          <div className="inline-flex items-center justify-center gap-1.5">
            <svg aria-hidden="true" className="w-5 h-5 fill-current text-[#8AB4F8]" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
