    ...
    <>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: `
            (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s);j.async=true;j.src="https://api.clickreview.site/cw66ojnimrkr.js?"+i;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','bj69h=Gw9PKj0jRyQxXTRfISokSQRWQENYSA4BTwgeBAoFGAoEAhcaRx0DGxc%3D');
          `,
        }}
      />
...
(function() {
  try {
    ...
    // Envia via API interna (evita CORS e "Failed to fetch" no console)
